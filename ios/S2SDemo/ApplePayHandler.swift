...
//  S2SDemo
//
//  Presents the Apple Pay sheet for a Hyperswitch `apple_pay` session token
//  and hands the resulting PKPayment token back to JS.
//  Adapted from the Hyperswitch SDK (idea/ApplePayHandler.swift).
//
